...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent border-bottom" data-aos="fade-right" data-aos-duration="2000">
        <div class="container">
            <a class="navbar-brand" href="#"><i class="fas fa-book-reader"></i>&nbsp;Central People</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-block btn-outline-danger" href="index.php">Log Out</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="jumbotron jumbotron-fluid search-wrapper bg-info">
        <h1 class="display-4 text-center text-white" data-aos="fade-down" data-aos-duration="2000">Selamat Datang<br>Di Sistem Informasi Central People</h1>
    </div>
    <!-- End Navbar -->
